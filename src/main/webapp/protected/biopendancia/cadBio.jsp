...
<div class="row-fluid" ng-controller="bioController">
	<h2>
		<p class="text-center">
			<spring:message code='header.avaliacao' />
	...
	<div>
		...
		<div
			...
			<h4>
				<i class="icon-info-sign"></i>
				<spring:message code="bio.emptyData" />
			</h4>
			<br />

			<p>
				<spring:message code="bio.emptyData.text" />
			</p>
		</div>
		...
		<div id="gridContainer"
			...
			<table class="table table-bordered table-striped">
				<thead>
					<tr>
						<th scope="col"><spring:message code="bio.massaMagra" /></th>
						<th scope="col"><spring:message code="bio.peso" /></th>
						<th scope="col"><spring:message code="bio.data" /></th>
						<th scope="col"><spring:message code="bio.gorduracorporal" /></th>
						<th scope="col"><spring:message code="bio.imc" /></th>
						<th scope="col"><spring:message code="bio.idadeMetabolica" /></th>
						<th scope="col"><spring:message code="bio.aguaCorporal" /></th>
						<th scope="col"><spring:message code="acao" /></th>
					</tr>
				</thead>
				<tbody>
					<tr ng-repeat="bio in page.source">
						<td class="tdContactsCentered">{{bio.name}}</td>
		...
		<div
			...
			<br /> <a href="#addBioModal" role="button"
		...
		<jsp:include page="dialogs/bioDialogs.jsp" />

	</div>
</div>

<script src="<c:url value="/resources/js/pages/biopendencia.js" />"></script>