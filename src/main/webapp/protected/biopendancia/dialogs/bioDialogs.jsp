...
<div class="modal fade" id="addBioModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="panel panel-primary">
			...
			<form name="newBioForm" accept-charset="utf-8">
				<div class="modal-body" style="padding: 5px;">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6"
							style="padding-bottom: 10px;">
							<input class="form-control" ng-model="biopendancia.massaMagra"
								placeholder="<spring:message code="bio.massaMagra" />" type="number"
								novalidate />
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6"
							style="padding-bottom: 10px;">
							<input class="form-control" ng-model="biopendancia.massaGorda"
								placeholder="<spring:message code="bio.massaGorda" />"
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12"
							style="padding-bottom: 10px;">
							<input class="form-control" ng-model="biopendancia.peso"
								placeholder="<spring:message code="bio.peso" />"
								type="text" novalidate />
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12"
							...
							<input class="form-control" type="date" id="dataNascimento"
								name="input" ng-model="biopendancia.dataAvaliacao"
								placeholder="<spring:message code='bio.dataAvaliacaos'/>" min="1900-01-01"
								novalidate />
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12"
							style="padding-bottom: 10px;">
							<input class="form-control" ng-model="biopendancia.idadeMetabolica"
								placeholder="<spring:message code="bio.idadeMetabolica" />" type="number"
								novalidate />
						</div>
					</div>
					<div class="row">
