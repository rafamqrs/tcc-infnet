...
<div class="row-fluid" ng-controller="pagamentoController">
	...
	<div>
		...
		<div
			...
			<h4>
				<i class="icon-info-sign"></i>
				<spring:message code="pagamento.emptyData" />
			</h4>
			<br />
		...
		<div id="gridContainer"
			...
			<table class="table table-bordered table-striped">
				<thead>
					<tr>
						<th scope="col"><spring:message code="pagamento.id" /></th>
						<th scope="col"><spring:message
								code="pagamento.formapagamento" /></th>
						<th scope="col"><spring:message code="pagamento.datacadastro" /></th>
						<th scope="col"><spring:message code="acao" /></th>
					</tr>
				</thead>
				<tbody>
					<tr ng-repeat="pagamento in page.source">
						<td class="tdContactsCentered">{{pagamento.idPagamento}}</td>
						<td class="tdContactsCentered">{{pagamento.formaPagamento}}</td>
		...
		<div
			...
			<br /> <a href="#addExercicioModal" role="button"
				...
				class="glyphicon glyphicon-plus"></i> &nbsp;&nbsp;<spring:message
					code="create" />&nbsp;<spring:message code="pagamento" />
			</a>
		</div>

		<jsp:include page="dialogs/pagamentoDialogs.jsp" />
